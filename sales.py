...
class salesClass:
    def __init__(self, root):
        ...
        #==Bill List ===
        sales_Frames=Frame(self.root,bd=3,relief=RIDGE)
        sales_Frames.place(x=50,y=140,width=200,height=330)

        scrolly=Scrollbar(sales_Frames,orient=VERTICAL)
        self.Sales_List=Listbox(sales_Frames,font=("goudy old style",15),bg="white",yscrollcommand=scrolly.set)
        ...
        #==Bill Area ===
        bill_Frames=Frame(self.root,bd=3,relief=RIDGE)
        bill_Frames.place(x=280,y=140,width=410,height=330)

        lbl_title2=Label(bill_Frames,text="Customer Bill Area",font=("goudy old style",20),bg="orange").pack(side=TOP,fill=X)

        scrolly2=Scrollbar(bill_Frames,orient=VERTICAL)
        self.bill_area=Text(bill_Frames,font=("goudy old style",15),bg="lightyellow",yscrollcommand=scrolly2.set)
        ...
        #==Image====
        self.bill_photo = Image.open("IRS latest\IRS\images\images\cat2.jpg")
...
#=========================================   
    ...
    def show(self):
        ...
        for i in os.listdir('C:/Users/Heth/Desktop/IRS latest (PRODUCT)/IRS latest/IRS/bill'):
